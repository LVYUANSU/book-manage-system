<template>
    <el-row style="margin-top: 20px;">
        ...
        <div style="margin: 0 auto;padding-block: 40px;">
                        ...
                        <div style="padding: 4px 6px;">
                            ...
                            <div style="margin-block: 6px;font-size: 12px;color: rgb(51,51,51);">
                                ...
                                <div style="margin-bottom: 10px;">
                                    <el-popover placement="top-start" :title="book.name" width="200" trigger="hover"
                                        :content="book.detail">
                                        <span class="edit-button" slot="reference">查看详情</span>
                                    </el-popover>
                                </div>
                                <div>
